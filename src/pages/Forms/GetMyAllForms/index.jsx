...
function GetMyAllForms({ tagFilter }) {
              ...
              <div className="flex-1 flex flex-col gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[14px] text-gray-600">{new Date(forms.expiry_date).toLocaleDateString()} - {forms.is_published ? "Published" : "Draft"}</p>
                  </div>
